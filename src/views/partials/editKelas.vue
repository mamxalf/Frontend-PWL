                    ...
                    <div class="content-wrapper">
                        <div id="main_konten">
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title my-4 text-center">Form Edit Data Kelas</h4>
                                        <hr>
                                        <form @submit.prevent="PostUpdate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" v-model="dataValue.total_students">
                                            </div>
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`https://backendpwl.mammam.website/classroom/${this.$route.params.id}`)
                .then((response) => {
        ...
        methods: {
            ...
            // }
            PostUpdate() {
                axios.put(`https://backendpwl.mammam.website/classroom/${this.$route.params.id}`, this.dataValue)
                    .then((response) => {
                        this.$router.push({
                            name: 'AdminSekolah'
                        });
