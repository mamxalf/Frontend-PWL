...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`https://backendpwl.mammam.website/input/${this.$route.params.id}`)
                .then((response) => {
        ...
        methods: {
            ...
            // }
            PostUpdate() {
                axios.put(`https://backendpwl.mammam.website/input/${this.$route.params.id}`, this.dataValue)
                    .then((response) => {
                        this.$router.push({
                            name: 'inputData'
                        });
